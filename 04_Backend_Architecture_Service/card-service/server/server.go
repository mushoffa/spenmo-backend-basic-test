...
type GrpcServer struct {
	...
	Services protos.CardServiceServer
}

// @Created 02/11/2021
// @Updated
func NewGrpcServer(port int, services protos.CardServiceServer, opt ...grpc.ServerOption) (*GrpcServer, error) {
...
func (s *GrpcServer) Run() error {
	...
	protos.RegisterCardServiceServer(s.Server, s.Services)
