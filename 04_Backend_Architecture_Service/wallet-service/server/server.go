...
type GrpcServer struct {
	...
	Services protos.WalletServiceServer
}

// @Created 19/10/2021
// @Updated 01/11/2021
func NewGrpcServer(port int, services protos.WalletServiceServer, opt ...grpc.ServerOption) (*GrpcServer, error) {
...
func (s *GrpcServer) Run() error {
	...
	protos.RegisterWalletServiceServer(s.Server, s.Services)
