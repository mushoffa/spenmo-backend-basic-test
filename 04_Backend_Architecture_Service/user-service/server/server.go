...
type GrpcServer struct {
	...
	Services  protos.UserServiceServer
}

// @Created 19/10/2021
// @Updated 01/11/2021
func NewGrpcServer(port int, services protos.UserServiceServer, opt ...grpc.ServerOption) (*GrpcServer, error) {
...
func (s *GrpcServer) Run() error {
	...
	protos.RegisterUserServiceServer(s.Server, s.Services)
